                        ...
                        <div class="bg-white sm:p-6 shadow sm:rounded-md">
                            <div class="grid grid-cols-3 gap-3 pl-8 pr-8 ml-8 mr-8">
                                <div v-for="(c,i) in categories" :key="i" class="mt-8 p-6 bg-white border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <div class="flex">
                                        <a :href="route('categories.public', { id: c.id })" class="w-full h-12 px-6 py-3 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                            View All
                                        </a>
                                    </div>
                                </div>
